...
from dataloaders.datasets.subtype_dataset import SubtypeDataset
import numpy as np
import pandas as pd
...
class SubtypeInference:
    def __init__(self, cfg):
        ...
        dataset = SubtypeDataset(**cfg['dataset'])
...
if __name__ == "__main__":
    cfg_path = 'configs/experiment/subtypetotal_inference.yaml'
    cfg = yaml.load(open(cfg_path, 'r'), Loader=yaml.FullLoader)

    task = SubtypeInference(cfg)
