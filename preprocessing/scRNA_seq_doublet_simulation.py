...
from doublet_simulation import doublet_simul


### Code for simulating doublets and saving cells as individual .pt files
data_path = '/home/gyutaek/hdd2/Data/Raw/scRNA_seq'
data_name = 'Jung_2022_unpublished_total'
path_save = join('/home/gyutaek/hdd2/Data/Process/scRNA_seq_process_subtype', data_name + '_simul')
...
# Simulate doublets and save new h5ad file
adata, adata_doublet = doublet_simul(adata, doublet_ratio=0.1)
adata = ad.concat([adata, adata_doublet], join='outer')
